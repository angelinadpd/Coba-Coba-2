<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <a class="brand" href="#">Hotel Online <small>backend</small></a>
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                    'items'=>array(
                        array('label'=>'Daskbord','url'=>array('/site/index')),
                        array('label'=>'Hotel', 'url'=>array('/hotel/index', 'view'=>'about')),
                        array('label'=>'Kamar', 'url'=>array('/kamar/index', 'view'=>'about')),
                        array('label'=>'Booking', 'url'=>array('/booking/index', 'view'=>'about')),
                        array('label'=>'Admin', 'url'=>array('/admin/index', 'view'=>'about')),
                        array('label'=>'Staff', 'url'=>array('/staff/index', 'view'=>'about')),
